...
RUN apk update && \
    apk add --no-cache freetype libpng libjpeg-turbo freetype-dev libpng-dev libjpeg-turbo-dev curl-dev libedit-dev libxml2-dev icu-dev gettext-dev libsodium-dev icu-libs libsodium libgd gd-dev libwebp zlib libxpm libwebp-dev zlib-dev libxpm-dev libjpeg jpeg-dev libzip-dev imagemagick-dev make nodejs npm autoconf build-base libzip imagemagick git imap imap-dev
